...
- docs: the intent pair guard starvation is reachable; pin it with tests [\#362](https://github.com/OpenVoiceOS/ovos-bus-client/pull/362) ([openvoiceos-bot](https://github.com/openvoiceos-bot))
...
- fix: honour the SESSION-2 §2.7 data carrier in the ovos.session.sync shim [\#342](https://github.com/OpenVoiceOS/ovos-bus-client/pull/342) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: own the pre-spec session shims bus-client grafts onto spec-tools [\#336](https://github.com/OpenVoiceOS/ovos-bus-client/pull/336) ([JarbasAl](https://github.com/JarbasAl))
